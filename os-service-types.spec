...
Source0  : https://files.pythonhosted.org/packages/74/ba/950eac3557ea6f2ce963cb4d9ad0d375794e4b8257ca5b12a68afd62524f/os-service-types-1.5.0.tar.gz
...
%prep
%setup -q -n os-service-types-1.5.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1548256698
